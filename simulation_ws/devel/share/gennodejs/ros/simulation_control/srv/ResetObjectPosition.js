...
class ResetObjectPositionRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ResetObjectPositionRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ResetObjectPositionRequest
    let len;
    let data = new ResetObjectPositionRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ResetObjectPositionRequest(null);
...
class ResetObjectPositionResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.new_state = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ResetObjectPositionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ResetObjectPositionResponse
    let len;
    let data = new ResetObjectPositionResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'simulation_control/ResetObjectPositionResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ResetObjectPositionResponse(null);
...
module.exports = {
  Request: ResetObjectPositionRequest,
  Response: ResetObjectPositionResponse,
  md5sum() { return 'b9c36716c61bd35f89c1c4d65dcd1b88'; },
  datatype() { return 'simulation_control/ResetObjectPosition'; }
};
