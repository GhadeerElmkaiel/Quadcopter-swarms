...
(cl:defclass <GetQuadcopterData-request> (roslisp-msg-protocol:ros-message)
  ((quadcopter_name
    :reader quadcopter_name
    :initarg :quadcopter_name
    :type cl:string
    :initform ""))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GetQuadcopterData-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetQuadcopterData-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulation_control-srv:<GetQuadcopterData-request> is deprecated: use simulation_control-srv:GetQuadcopterData-request instead.")))

(cl:ensure-generic-function 'quadcopter_name-val :lambda-list '(m))
(cl:defmethod quadcopter_name-val ((m <GetQuadcopterData-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_control-srv:quadcopter_name-val is deprecated.  Use simulation_control-srv:quadcopter_name instead.")
  (quadcopter_name m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <GetQuadcopterData-request>) ostream)
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'quadcopter_name))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'quadcopter_name))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GetQuadcopterData-request>) istream)
  "Deserializes a message object of type '<GetQuadcopterData-request>"
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:slot-value msg 'quadcopter_name) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'quadcopter_name) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetQuadcopterData-request>)))
  ...
  "simulation_control/GetQuadcopterDataRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetQuadcopterData-request)))
  "Returns string type for a service object of type 'GetQuadcopterData-request"
  "simulation_control/GetQuadcopterDataRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetQuadcopterData-request>)))
  ...
  "bda7fb9bcb992692c1da67536514aeb3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetQuadcopterData-request)))
  "Returns md5sum for a message object of type 'GetQuadcopterData-request"
  "bda7fb9bcb992692c1da67536514aeb3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetQuadcopterData-request>)))
  ...
  (cl:format cl:nil "string quadcopter_name~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetQuadcopterData-request)))
  "Returns full string definition for message of type 'GetQuadcopterData-request"
  (cl:format cl:nil "string quadcopter_name~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <GetQuadcopterData-request>))
  (cl:+ 0
     4 (cl:length (cl:slot-value msg 'quadcopter_name))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <GetQuadcopterData-request>))
  ...
  (cl:list 'GetQuadcopterData-request
    (cl:cons ':quadcopter_name (quadcopter_name msg))
))
...
(cl:defmethod cl:initialize-instance :after ((m <GetQuadcopterData-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetQuadcopterData-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulation_control-srv:<GetQuadcopterData-response> is deprecated: use simulation_control-srv:GetQuadcopterData-response instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <GetQuadcopterData-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_control-srv:state-val is deprecated.  Use simulation_control-srv:state instead.")
  (state m))

(cl:ensure-generic-function 'imu-val :lambda-list '(m))
(cl:defmethod imu-val ((m <GetQuadcopterData-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_control-srv:imu-val is deprecated.  Use simulation_control-srv:imu instead.")
  (imu m))

(cl:ensure-generic-function 'magnetic-val :lambda-list '(m))
(cl:defmethod magnetic-val ((m <GetQuadcopterData-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_control-srv:magnetic-val is deprecated.  Use simulation_control-srv:magnetic instead.")
  (magnetic m))

(cl:ensure-generic-function 'sonar-val :lambda-list '(m))
(cl:defmethod sonar-val ((m <GetQuadcopterData-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_control-srv:sonar-val is deprecated.  Use simulation_control-srv:sonar instead.")
  (sonar m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetQuadcopterData-response>)))
  ...
  "simulation_control/GetQuadcopterDataResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetQuadcopterData-response)))
  "Returns string type for a service object of type 'GetQuadcopterData-response"
  "simulation_control/GetQuadcopterDataResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetQuadcopterData)))
  ...
  "simulation_control/GetQuadcopterData")